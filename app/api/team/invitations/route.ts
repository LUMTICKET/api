...
export async function POST(req: NextRequest) {
  try {
    ...
    // UPDATE: Set base URL to frontend URL path /invitations/[token]
    const baseUrl = process.env.APP_URL || "https://luticketnewui.vercel.app";
    const acceptLink = `${baseUrl}/invitations/${token}`;
